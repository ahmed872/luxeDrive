...
const { E2E_OWNER, E2E_STAFF, E2E_MANAGER, E2E_DISABLED, E2E_ACCEPTANCE_OWNER, E2E_USERS_OWNER } =
...
console.log(
  '✓ e2e admin fixtures ready: e2e-owner, e2e-staff, e2e-manager, e2e-disabled, e2e-acceptance, e2e-users-owner',
);
await db.$disconnect();
